...
Describe 'Testing It' {
    It 'Throws when missing name' {
        ...
        } | Should-Throw -ExceptionMessage 'Test name has multiple lines and no test scriptblock is provided*'
    }
    ...
    It 'Throws when missing scriptblock' {
        ...
        } | Should-Throw -ExceptionMessage 'No test scriptblock is provided*'
    }

    It 'Throws when provided unbound scriptblock' {
        # Unbound scriptblocks would execute in Pester's internal module state
        { It 'i' -Test ([scriptblock]::Create('')) } | Should-Throw -ExceptionMessage 'Unbound scriptblock*'
    }
}
