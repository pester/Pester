...
namespace Pester
{
    public class Block
    {
        ...
        public ScriptBlock EachDescribeSetup { get; set; }
        public ScriptBlock EachContextSetup { get; set; }
        public ScriptBlock EachDescribeTeardown { get; set; }
        public ScriptBlock EachContextTeardown { get; set; }
