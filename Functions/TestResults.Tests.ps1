    ...
    Describe "Write nunit test results" {
        ...
        It "should write a failed test result" {
         ...
         It "should write the test summary" {
            ...
            $xmlTestResult.date     | Should Not Be $null
            $xmlTestResult.time     | Should Not Be $null
        }
        ...
        it "should write the environment information" {
            ...
            $xmlEnvironment.'os-Version'    | Should Not Be $null
            $xmlEnvironment.platform        | Should Not Be $null
